...
<html><head><title>SortedTable example</title>
    ...
    function moveRows(s,d) {
		...
		<div class="content">				
			...
			<table class="sorted regroup" cellpadding="0" cellspacing="0">
				...
				<tbody>
                <tr class="even" style="cursor: pointer;" id="row1">
                	<td axis="number" headers="order">1</td>
...
$admin = mysql_query("SELECT * FROM register");
        ...
        <tr class="odd" style="cursor: pointer;"><td axis="number" headers="order">2</td>
        
        			<td axis="string" headers="title">title 2 </td>
                    
                    <td axis="date" headers="date" title="2006-08-04">4.8.2006</td>
                    
                    <td axis="number" headers="num">71</td>
                    
                    <td axis="sstring" headers="desc">description 2 </td><td axis="date" headers="publish" title="2005-03-05">5.3.2005</td><td headers="published">o</td></tr>
