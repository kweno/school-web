...
<table class="sorted" id="s" cellpadding="0" cellspacing="0">
            <form name="form1" method="post" action="">
				...
				<thead>
					...
					<th style="cursor: pointer;" id="sname"><span>Firstname</span></th>
					<th style="cursor: pointer;" id="sbirth"><span>Lastname</span></th>
                    <th style="cursor: pointer;" id="sbirth"><span>Age</span></th>
                    <th style="cursor: pointer;" id="sbirth"><span>Gender</span></th>
                    <th style="cursor: pointer;" id="sbirth"><span>Email</span></th>
                    <th style="cursor: pointer;" id="sbirth"><span>Username</span></th>
                    <th style="cursor: pointer;" id="sbirth"><span>Passw</span></th>
                    <th style="cursor: pointer;" id="sbirth"><span>Re-Pass</span></th>
                                  <th style="cursor: pointer;" id="sbirth"><span>Status</span></th>
					</tr>
				</thead>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     <input name="delete" type="submit" id="delete1" value="Delete"><input name="delete" type="submit" id="delete2" value="Refresh" >
			...
			<table class="sorted" id="d" cellpadding="0" cellspacing="0">
				<thead>
					<tr>
						...
						<th style="cursor: pointer;" id="dbirth"><span>Firstname</span></th>
                        	<th style="cursor: pointer;" id="dbirth"><span>Lastname</span></th>
                            	<th style="cursor: pointer;" id="dbirth"><span>Age</span></th>
                                <th style="cursor: pointer;" id="dbirth"><span>Gender</span></th>
                                <th style="cursor: pointer;" id="dbirth"><span>Email</span></th>
                                <th style="cursor: pointer;" id="dbirth"><span>Username</span></th>
                                <th style="cursor: pointer;" id="dbirth"><span>Pass</span></th>
                                 <th style="cursor: pointer;" id="dbirth"><span>Re-Pass</span></th>
                                  <th style="cursor: pointer;" id="dbirth"><span>Status</span></th>
					</tr>
				</thead>
